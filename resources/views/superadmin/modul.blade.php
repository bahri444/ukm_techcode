...
@section('content')
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-4">
                                    ...
                                    <a href="/updatemodul/{{ $val->modul_uuid }}" type="button"
                                    ...
                                    <button data-modal-target="modalHapus{{ $val->modul_uuid }}"
                                        data-modal-toggle="modalHapus{{ $val->modul_uuid }}" type="button"
    ...
    @foreach ($data as $rows)
        <!-- Modal hapus -->
        <div id="modalHapus{{ $rows->modul_uuid }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="modalHapus{{ $rows->modul_uuid }}">
                    ...
                    <div class="p-4 md:p-5 space-y-2">
                        ...
                        <div class="flex items-center p-2 md:p-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="modalHapus{{ $rows->modul_uuid }}" type="button"
                            ...
                            <a href="/deletemodul/{{ $rows->modul_uuid }}"
